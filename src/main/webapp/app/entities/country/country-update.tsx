  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meApplicationApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="meApplicationApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meApplicationApp.country.countryName')}
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('meApplicationApp.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
