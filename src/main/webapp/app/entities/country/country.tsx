  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="meApplicationApp.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="meApplicationApp.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/country/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="meApplicationApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="meApplicationApp.country.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('countryName')}>
                  <Translate contentKey="meApplicationApp.country.countryName">Country Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('countryName')} />
                </th>
                <th>
                  <Translate contentKey="meApplicationApp.country.region">Region</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="meApplicationApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
