...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="meApplicationApp.department.delete.question">
        <Translate contentKey="meApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
