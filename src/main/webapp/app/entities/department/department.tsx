  ...
  return (
    <div>
      <h2 id="department-heading" data-cy="DepartmentHeading">
        <Translate contentKey="meApplicationApp.department.home.title">Departments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="meApplicationApp.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/department/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="meApplicationApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="meApplicationApp.department.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('departmentName')}>
                  <Translate contentKey="meApplicationApp.department.departmentName">Department Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('departmentName')} />
                </th>
                <th>
                  <Translate contentKey="meApplicationApp.department.location">Location</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="meApplicationApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
