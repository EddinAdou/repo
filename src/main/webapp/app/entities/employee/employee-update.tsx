  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meApplicationApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="meApplicationApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meApplicationApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('meApplicationApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('meApplicationApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('meApplicationApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('meApplicationApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('meApplicationApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('meApplicationApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('meApplicationApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('meApplicationApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
