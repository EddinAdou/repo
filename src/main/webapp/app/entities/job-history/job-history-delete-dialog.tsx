...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="meApplicationApp.jobHistory.delete.question">
        <Translate contentKey="meApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
