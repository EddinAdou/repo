  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meApplicationApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="meApplicationApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meApplicationApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('meApplicationApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('meApplicationApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('meApplicationApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('meApplicationApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('meApplicationApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('meApplicationApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
