  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meApplicationApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="meApplicationApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meApplicationApp.job.jobTitle')}
                id="job-jobTitle"
                name="jobTitle"
                data-cy="jobTitle"
                type="text"
              />
              <ValidatedField
                label={translate('meApplicationApp.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('meApplicationApp.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField
                label={translate('meApplicationApp.job.task')}
                id="job-task"
                data-cy="task"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('meApplicationApp.job.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
