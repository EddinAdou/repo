  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meApplicationApp.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="meApplicationApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meApplicationApp.region.regionName')}
